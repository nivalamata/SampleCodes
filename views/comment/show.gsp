	...
	<body>
		...
		<div id="show-comment" class="content scaffold-show" role="main">
			...
			<ol class="property-list comment">
				...
				<g:if test="${commentInstance?.employeeComment}">
				<li class="fieldcontain">
					<span id="employeeComment-label" class="property-label"><g:message code="comment.employeeComment.label" default="Employee Comment" /></span>
					
						<span class="property-value" aria-labelledby="employeeComment-label"><g:fieldValue bean="${commentInstance}" field="employeeComment"/></span>
