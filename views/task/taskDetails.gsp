...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'task.label', default: 'Task Details')}" />
		...
		<div id="show-task" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
			      ...
			      <g:link class="attachment"  controller="comment" action="comment" id="${taskInstance?.id}">Post Comment  </g:link>
				<g:link class="attachment"  controller="taskReport" action="report" id="${taskInstance?.id}">submit Task Report </g:link>
