...
<html>
	...
	<body>
		<a href="#edit-taskReport" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div class="nav" role="navigation">
			...
			<div class="myform">
		<div id="edit-taskReport" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${taskReportInstance?.version}" />
				<fieldset class="form">
