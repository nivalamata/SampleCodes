...
class ProfileController {
    ...
    def index() {
        redirect(action: "listProfile", params: params)
    }
    ...
    def save() {
        ...
        redirect(action: "showProfile", id: profileInstance.id)
    }
    ...
    def delete() {
        ...
        try {
            ...
            redirect(action: "showProfile", id: params.id)
        }
    }
}
